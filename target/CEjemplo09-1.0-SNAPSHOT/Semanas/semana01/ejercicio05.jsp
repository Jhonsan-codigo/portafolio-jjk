...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 05 - Cubo | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-cube"></i> Cubo</h1>
            <p class="descripcion">Diseñe un programa que determine el área (A) y el volumen (V) de un cubo del que se conoce su lado (l).</p>
        </div>
        <div class="formulas">
        ...
        <form action="calcular05" method="POST">
            <div class="form-group"><label for="lado"><i class="fas fa-cube"></i> Lado (l) en metros</label><input type="number" name="lado" id="lado" step="any" min="0" placeholder="Ejemplo: 5" required></div>
        ...
        %>
        <% String area05 = (String) request.getAttribute("area"); String volumen05 = (String) request.getAttribute("volumen"); if (area05 != null && volumen05 != null) { %><div class="resultados"><div class="result-card"><div class="label"><i class="fas fa-square"></i> Área</div><div class="valor"><%= area05 %></div><div class="unidad">m²</div></div><div class="result-card"><div class="label"><i class="fas fa-cube"></i> Volumen</div><div class="valor"><%= volumen05 %></div><div class="unidad">m³</div></div></div><% } %>
