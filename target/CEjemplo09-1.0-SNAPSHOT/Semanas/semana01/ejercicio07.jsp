...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 07 - Número Invertido | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-sync-alt"></i> Número Invertido</h1>
            <p class="descripcion">Dado un número de 05 dígitos, devolver el número en orden inverso.</p>
        </div>
        <div class="formulas">
        ...
        <form action="calcular07" method="POST">
            <div class="form-group"><label for="numero"><i class="fas fa-hashtag"></i> Número de 5 dígitos</label><input type="number" name="numero" id="numero" step="1" min="10000" max="99999" placeholder="Ejemplo: 12345" required></div>
        ...
        %>
        <% String numOriginal = (String) request.getAttribute("numero"); String numInvertido = (String) request.getAttribute("invertido"); if (numOriginal != null && numInvertido != null) { %><div class="resultados"><div class="result-card"><div class="label"><i class="fas fa-sync-alt"></i> Número Original</div><div class="valor"><%= numOriginal %></div></div><div class="result-card"><div class="label"><i class="fas fa-undo"></i> Número Invertido</div><div class="valor"><%= numInvertido %></div></div></div><% } %>
