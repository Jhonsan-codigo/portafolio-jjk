...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 06 - Sueldo ESSALUD + AFP | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-hospital"></i> Sueldo ESSALUD + AFP</h1>
            <p class="descripcion">Calculo del sueldo de un empleado con descuento por ESSALUD (9%) y AFP (10%) sobre el sueldo bruto.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Formulas</h3>
            <div class="formula">Sueldo Bruto = Horas x Tarifa Horaria</div>
            <div class="formula">Descuento ESSALUD = Sueldo Bruto x 0.09</div>
            <div class="formula">Descuento AFP = Sueldo Bruto x 0.10</div>
            <div class="formula">Descuento Total = ESSALUD + AFP</div>
            <div class="formula">Sueldo Neto = Sueldo Bruto - Descuento Total</div>
        </div>
        <form action="calcular06" method="POST">
            <div class="form-group">
                <label for="horas"><i class="fas fa-clock"></i> Horas trabajadas</label>
                <input type="number" name="horas" id="horas" step="any" min="0" placeholder="Ejemplo: 160" required>
            </div>
            <div class="form-group">
                <label for="tarifa"><i class="fas fa-coins"></i> Tarifa horaria (S/)</label>
                <input type="number" name="tarifa" id="tarifa" step="any" min="0" placeholder="Ejemplo: 20.00" required>
            </div>
        ...
        <% } %>
        <% if (request.getAttribute("sueldoBruto") != null) { %>
        <div class="resultados">
            <div class="result-card">
                <div class="label"><i class="fas fa-money-bill"></i> Sueldo Bruto</div>
                <div class="valor">S/ <%= request.getAttribute("sueldoBruto") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-hospital"></i> Descuento ESSALUD (9%)</div>
                <div class="valor">S/ <%= request.getAttribute("descuentoEssalud") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-piggy-bank"></i> Descuento AFP (10%)</div>
                <div class="valor">S/ <%= request.getAttribute("descuentoAfp") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-minus-circle"></i> Descuento Total</div>
                <div class="valor">S/ <%= request.getAttribute("descuentoTotal") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-hand-holding-usd"></i> Sueldo Neto</div>
