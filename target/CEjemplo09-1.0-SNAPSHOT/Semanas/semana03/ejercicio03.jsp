...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 03 - Sueldo Empleado | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-user-tie"></i> Sueldo Empleado</h1>
            <p class="descripcion">Calculo del pago mensual de un empleado considerando horas trabajadas, bonificacion del 20% y descuento del 10%.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Formulas</h3>
            <div class="formula">Sueldo Basico = Horas x Tarifa Horaria</div>
            <div class="formula">Bonificacion = Sueldo Basico x 0.20</div>
            <div class="formula">Sueldo Bruto = Sueldo Basico + Bonificacion</div>
            <div class="formula">Descuento = Sueldo Bruto x 0.10</div>
        ...
        <form action="calcular03" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="tarifa" id="tarifa" step="any" min="0" placeholder="Ejemplo: 15.00" required>
            </div>
        ...
        <div class="resultados">
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-gift"></i> Bonificacion (20%)</div>
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-minus-circle"></i> Descuento (10%)</div>
