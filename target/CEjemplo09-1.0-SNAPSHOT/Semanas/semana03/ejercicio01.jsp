...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 01 - Descuento 11% | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-percent"></i> Descuento 11%</h1>
            <p class="descripcion">Una tienda ofrece 11% de descuento sobre el importe de la compra. Ademas, obsequia 2 caramelos por cada unidad adquirida.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Formulas</h3>
            <div class="formula">Importe Compra = Precio x Cantidad</div>
            <div class="formula">Descuento = Importe Compra x 0.11</div>
            <div class="formula">Importe a Pagar = Importe Compra - Descuento</div>
            <div class="formula">Caramelos = Cantidad x 2</div>
        </div>
        <form action="calcular01" method="POST">
            <div class="form-group">
                <label for="precio"><i class="fas fa-tag"></i> Precio del producto (S/)</label>
                <input type="number" name="precio" id="precio" step="any" min="0" placeholder="Ejemplo: 25.50" required>
            </div>
            <div class="form-group">
                <label for="cantidad"><i class="fas fa-shopping-cart"></i> Cantidad de unidades</label>
                <input type="number" name="cantidad" id="cantidad" min="1" placeholder="Ejemplo: 4" required>
            </div>
        ...
        <div class="resultados">
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-percent"></i> Importe del Descuento (11%)</div>
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-candy-cane"></i> Caramelos de Obsequio</div>
                <div class="valor"><%= request.getAttribute("caramelos") %></div>
                <div class="unidad">caramelos</div>
            </div>
        </div>
        <% } %>
