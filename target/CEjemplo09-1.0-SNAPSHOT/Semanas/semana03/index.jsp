...
<head>
    ...
    <title>Semana 3 - Ejercicios | JJK</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="numero">Semana 3</div>
            <h1><i class="fas fa-code"></i> Ejercicios Java</h1>
            <p>6 ejercicios de programacion con descuentos, sueldos y calculos comerciales</p>
        </div>
        <div class="ejercicios-grid">
            <a href="ejercicio01.jsp" class="ejercicio-card">
                <div class="num">01</div>
                <div class="titulo">Descuento 11%</div>
                <div class="desc">Calcula descuento del 11% y caramelos de obsequio por compra</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio02.jsp" class="ejercicio-card">
                <div class="num">02</div>
                <div class="titulo">Descuento 10% + 10%</div>
                <div class="desc">Aplica dos descuentos del 10% sucesivamente sobre la compra</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio03.jsp" class="ejercicio-card">
                <div class="num">03</div>
                <div class="titulo">Sueldo Empleado</div>
                <div class="desc">Calcula sueldo con bonificacion del 20% y descuento del 10%</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio04.jsp" class="ejercicio-card">
                <div class="num">04</div>
                <div class="titulo">Transporte</div>
                <div class="desc">Descuento del 7% y chocolates de obsequio por pasajes</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio05.jsp" class="ejercicio-card">
                <div class="num">05</div>
                <div class="titulo">Sueldo Vendedor</div>
                <div class="desc">Sueldo base S/300, comision 9% y descuento 11% sobre ventas</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio06.jsp" class="ejercicio-card">
                <div class="num">06</div>
                <div class="titulo">Sueldo ESSALUD + AFP</div>
                <div class="desc">Descuentos por ESSALUD (9%) y AFP (10%) sobre sueldo bruto</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
        </div>
        <div class="footer">
