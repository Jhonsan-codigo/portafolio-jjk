...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 01 - Serie Aritmetica | Jhon Contreras</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .formula { color: #7dd3fc; font-size: 1.2rem; margin: 8px 0; font-family: 'Courier New', monospace; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-list-ol"></i> Serie Aritmetica</h1>
            <p class="descripcion">Imprime y suma la serie: 3, 10, 17, 24, 31, ... hasta n terminos.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Serie</h3>
            <div class="formula">3, 10, 17, 24, 31, ...</div>
            <div class="formula">Diferencia = +7</div>
        </div>
        <form action="calcular01" method="POST">
            <div class="form-group">
                <label for="n"><i class="fas fa-hashtag"></i> Numero de terminos (n)</label>
                <input type="number" name="n" id="n" min="1" placeholder="Ejemplo: 10" required>
            </div>
        ...
        <div class="resultados">
            ...
            <div class="result-card">
                ...
                <div class="serie-texto"><%= request.getAttribute("serie") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-plus"></i> Suma de la Serie</div>
