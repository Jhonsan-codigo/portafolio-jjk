...
<head>
    ...
    <title>Semana 6 - Ejercicios | JJK</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="numero">Semana 6</div>
            <h1><i class="fas fa-code"></i> Ejercicios Java</h1>
            <p>3 proyectos de programación con condicionales y descuentos</p>
        </div>
        <div class="ejercicios-grid">
            <a href="ejercicio01.jsp" class="ejercicio-card">
                <div class="num">01</div>
                <div class="titulo">Dulce Porvenir</div>
                <div class="desc">Venta de chocolates con descuentos por cantidad y obsequio de caramelos</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio02.jsp" class="ejercicio-card">
                <div class="num">02</div>
                <div class="titulo">Angelito Azules</div>
                <div class="desc">Venta de boletos de bus con descuento por calidad A y cantidad mayor a 4</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
            <a href="ejercicio03.jsp" class="ejercicio-card">
                <div class="num">03</div>
                <div class="titulo">Libretas Militares</div>
                <div class="desc">Cálculo de descuento según edad y nivel del sistema de beneficio</div>
                <span class="btn">Resolver <i class="fas fa-arrow-right"></i></span>
            </a>
        </div>
        <div class="footer">
