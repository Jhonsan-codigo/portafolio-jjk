...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 01 - Dulce Porvenir | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-candy-cane"></i> Dulce Porvenir</h1>
            <p class="descripcion">Venta de chocolates con descuentos por cantidad y obsequio de caramelos.</p>
        </div>
        <div class="tabla-precios">
            <h3><i class="fas fa-tag"></i> Precios por Tipo</h3>
            <table>
                <tr><th>Tipo</th><th>Precio Unitario</th></tr>
                <tr><td>Primor</td><td>S/ 8.50</td></tr>
                <tr><td>Dulzura</td><td>S/ 10.00</td></tr>
                <tr><td>Tentación</td><td>S/ 7.00</td></tr>
                <tr><td>Explosión</td><td>S/ 12.50</td></tr>
            </table>
        </div>
        <form action="calcular01" method="POST">
            <div class="form-group">
                <label for="tipo"><i class="fas fa-cookie-bite"></i> Tipo de Chocolate</label>
            ...
            <div class="form-group">
                <label for="cantidad"><i class="fas fa-hashtag"></i> Cantidad de Chocolates</label>
        ...
        <div class="resultados">
            <div class="result-card">
                <div class="label"><i class="fas fa-cookie-bite"></i> Tipo de Chocolate</div>
                <div class="valor-sec"><%= request.getAttribute("tipo") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-hashtag"></i> Cantidad</div>
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-percent"></i> Descuento (<%= request.getAttribute("porcentajeDesc") %>%)</div>
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-gift"></i> Caramelos de Obsequio</div>
                <div class="valor"><%= request.getAttribute("caramelos") %></div>
            </div>
        </div>
        <% } %>
