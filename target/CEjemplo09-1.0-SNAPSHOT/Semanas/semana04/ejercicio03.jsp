...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 03 - Estacionamiento | Jhon Contreras</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .hora-row { display: flex; gap: 15px; }
        .hora-row .form-group { flex: 1; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-parking"></i> Estacionamiento</h1>
            <p class="descripcion">Tarifa de estacionamiento segun el dia de la semana. Se cobra por hora o fraccion.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Tarifas</h3>
            <div class="formula">Lunes a Jueves: S/ 3.50/hora</div>
            <div class="formula">Viernes y Sabado: S/ 4.50/hora</div>
            <div class="formula">Domingo: S/ 2.50/hora</div>
        </div>
        <form action="calcular03" method="POST">
            <div class="form-group">
                <label for="dia"><i class="fas fa-calendar-day"></i> Dia de la semana</label>
            ...
            <label style="display:block;color:#94a3b8;font-size:0.95rem;margin-bottom:10px;font-weight:500"><i class="fas fa-clock"></i> Hora de entrada</label>
            <div class="hora-row">
                <div class="form-group">
                    <input type="number" name="horaEntrada" min="0" max="23" placeholder="Hora (0-23)" required>
                </div>
                <div class="form-group">
                    <input type="number" name="minEntrada" min="0" max="59" placeholder="Min (0-59)" required>
                </div>
            </div>
            <label style="display:block;color:#94a3b8;font-size:0.95rem;margin-bottom:10px;font-weight:500"><i class="fas fa-clock"></i> Hora de salida</label>
            <div class="hora-row">
                <div class="form-group">
                    <input type="number" name="horaSalida" min="0" max="23" placeholder="Hora (0-23)" required>
                </div>
                <div class="form-group">
                    <input type="number" name="minSalida" min="0" max="59" placeholder="Min (0-59)" required>
                </div>
            </div>
        ...
        <% } %>
        <% if (request.getAttribute("montoPagar") != null) { %>
        <div class="resultados">
            <div class="result-card">
                <div class="label"><i class="fas fa-calendar-day"></i> Dia</div>
                <div class="valor" style="font-size:1.5rem"><%= request.getAttribute("dia") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-sign-in-alt"></i> Hora de Entrada</div>
                <div class="valor" style="font-size:1.5rem"><%= request.getAttribute("horaEntrada") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-sign-out-alt"></i> Hora de Salida</div>
                <div class="valor" style="font-size:1.5rem"><%= request.getAttribute("horaSalida") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-hourglass-half"></i> Tiempo Total</div>
                <div class="valor"><%= request.getAttribute("minutos") %></div>
                <div class="unidad">minutos</div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-clock"></i> Horas Cobradas</div>
                <div class="valor"><%= request.getAttribute("horas") %></div>
                <div class="unidad">horas (redondeo arriba)</div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-tag"></i> Tarifa por Hora</div>
                <div class="valor">S/ <%= request.getAttribute("tarifa") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-hand-holding-usd"></i> Monto a Pagar</div>
                <div class="valor">S/ <%= request.getAttribute("montoPagar") %></div>
            </div>
        </div>
        <% } %>
