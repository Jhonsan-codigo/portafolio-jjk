...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Sueldo con ESSALUD y AFP</h1>
            <p class="descripcion">Cálculo del sueldo de empleados con descuento por ESSALUD (9%) y AFP (10%) sobre el sueldo bruto.</p>
        </div>
        
        <div class="formulas">
            <h3><i class="fas fa-calculator"></i> Fórmulas</h3>
            <div class="formula">Sueldo Bruto = Horas × Tarifa</div>
            <div class="formula">Descuento ESSALUD = Bruto × 0.09</div>
            <div class="formula">Descuento AFP = Bruto × 0.10</div>
            <div class="formula">Descuento Total = ESSALUD + AFP</div>
            <div class="formula">Sueldo Neto = Bruto - Descuento Total</div>
        </div>
        
        <form action="${pageContext.request.contextPath}/Semanas/semana02/calcular06" method="POST">
        ...
        <% if (request.getAttribute("sueldoBruto") != null) { %>
            <div class="resultados">
                ...
                <div class="result-card">
                    <div class="label">Descuento ESSALUD (9%)</div>
                    <div class="valor">S/ <%= request.getAttribute("descuentoEssalud") %></div>
                </div>
                <div class="result-card">
                    <div class="label">Descuento AFP (10%)</div>
