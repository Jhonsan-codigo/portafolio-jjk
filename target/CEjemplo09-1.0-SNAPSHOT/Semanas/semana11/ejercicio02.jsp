...
<head>
    ...
    <title>Ejercicio 02 - Distancia Euclidiana | JJK</title>
    ...
    <style>
        ...
        .carta-maldita::before {
            ...
            height: 3px;
            background: linear-gradient(90deg, var(--jjk-gojo), var(--jjk-gold));
            transform: scaleX(0);
        ...
        .carta-maldita:hover {
            ...
            box-shadow: 0 20px 50px rgba(0, 102, 204, 0.15), 0 0 60px rgba(0,102,204,0.08);
        }
        ...
        .form-group input:focus {
            border-color: var(--jjk-gojo-bright);
        ...
        @media (max-width: 768px) {
            ...
            .puntos-row { grid-template-columns: 1fr; }
            .coordenadas-row { grid-template-columns: 1fr; }
            .puntos-resultado { grid-template-columns: 1fr; }
...
<body>
    ...
    <div class="ejercicios-page">
        <section class="ejercicios-hero">
            ...
            <div class="hero-content">
                <div class="semana-power-badge">
                    <i class="fas fa-ruler-combined"></i> Dominio Geométrico
                </div>
                <h1 class="semana-title-main">DISTANCIA EUCLIDIANA</h1>
                <p class="semana-desc-main">
                    Calcula la distancia en línea recta entre dos puntos en el plano cartesiano con precisión absoluta.
                </p>
            </div>
        </section>
        ...
        <div class="ejercicios-grid">
            <div class="carta-maldita">
                <div class="carta-header">
                    ...
                    <h3 class="carta-titulo">Calculadora de Distancia</h3>
                    <p class="carta-desc">
                        Ingresa las coordenadas de <strong style="color: var(--jjk-gojo-bright);">dos puntos</strong> y obtén la distancia usando la fórmula de Pitágoras.
                    </p>
                </div>
                <div class="carta-body">
                    <form action="calcular02" method="POST">
                        <div class="puntos-row">
                            <div class="punto-grupo">
                                <div class="punto-titulo"><i class="fas fa-map-marker-alt"></i> Punto P₁</div>
                                <div class="coordenadas-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="y1" name="y1" step="any" 
                            ...
                            <div class="punto-grupo">
                                ...
                                <div class="coordenadas-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="x2" name="x2" step="any" 
                                               placeholder="Ej: 4" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="y2">y₂</label>
                                        <input type="number" id="y2" name="y2" step="any" 
                                               placeholder="Ej: 6" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn-lanzar btn-distancia">
                            <i class="fas fa-ruler"></i> Calcular Distancia
                        </button>
                    </form>
                    ...
                    <% 
                            ...
                            String y1 = (String) request.getAttribute("y1");
                            String x2 = (String) request.getAttribute("x2");
                            String y2 = (String) request.getAttribute("y2");
                            ...
                            if (distancia != null) {
                    %>
                        <div class="resultado-caja res-distancia">
                            <div class="resultado-label">Distancia Calculada</div>
                            <div class="formula-display">
                                d = √[(<%= x2 %> - <%= x1 %>)² + (<%= y2 %> - <%= y1 %>)²]
                            </div>
                            <div class="resultado-valor"><%= distancia %></div>
                            <div class="puntos-resultado">
                                <div class="punto-res">
                                    <div class="punto-label">Punto P₁</div>
                                    <div class="punto-valor">(<%= x1 %>, <%= y1 %>)</div>
                                </div>
                                <div class="punto-res">
                                    <div class="punto-label">Punto P₂</div>
                                    <div class="punto-valor">(<%= x2 %>, <%= y2 %>)</div>
                                </div>
                            </div>
        ...
        <footer class="footer-ej">
            <div class="curse-mark" style="font-size: 2.5rem; color: var(--jjk-gojo-bright); opacity: 0.2; margin-bottom: 10px;">呪</div>
            ...
            <p style="margin-top: 10px; font-size: 0.85rem; font-family: 'Cinzel', serif; color: #505060;">
                "La distancia más corta entre dos puntos es una línea recta... maldita."
            </p>
        </footer>
    </div>
