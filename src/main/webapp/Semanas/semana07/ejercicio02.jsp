...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 02 - Inversor de Cadenas | Jhon Contreras</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .result-card .valor { color: #00c6ff; font-size: 1.5rem; font-weight: 700; word-break: break-all; }
        .result-card .original { color: #7dd3fc; font-size: 1.2rem; margin-bottom: 10px; word-break: break-all; }
        .result-card .flecha { color: #00c6ff; font-size: 1.5rem; margin: 10px 0; }
        .result-card .invertido { color: #fff; font-size: 1.5rem; font-weight: 700; word-break: break-all; }
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-exchange-alt"></i> Inversor de Cadenas</h1>
            <p class="descripcion">Ingresa un texto y obtén el mismo texto al revés, sin usar StringBuilder.</p>
        </div>
        <div class="metodos">
        ...
        <form action="calcular02" method="POST">
            <div class="form-group">
                <label for="texto"><i class="fas fa-keyboard"></i> Ingrese un texto</label>
                <input type="text" name="texto" id="texto" placeholder="Ejemplo: Programacion" required>
            </div>
            <button type="submit" class="btn-calcular"><i class="fas fa-calculator"></i> Invertir Texto</button>
        </form>
        ...
        <div class="resultados">
            <div class="result-card">
                <div class="label"><i class="fas fa-file-alt"></i> Texto Original</div>
                <div class="original"><%= request.getAttribute("original") %></div>
                <div class="flecha"><i class="fas fa-arrow-down"></i></div>
                <div class="label"><i class="fas fa-undo"></i> Texto Invertido</div>
                <div class="invertido"><%= request.getAttribute("invertido") %></div>
            </div>
        </div>
        <% } %>
