...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 05 - Sueldo Vendedores | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Sueldo de Vendedores</h1>
            <p class="descripcion">Cálculo del sueldo de vendedores: sueldo básico S/300, comisión del 9% sobre ventas, sueldo bruto, descuento del 11% y sueldo neto.</p>
        </div>
        
        <div class="formulas">
            <h3><i class="fas fa-calculator"></i> Fórmulas</h3>
            <div class="formula">Sueldo Básico = S/ 300.00</div>
            <div class="formula">Comisión = Ventas × 0.09</div>
            <div class="formula">Sueldo Bruto = Básico + Comisión</div>
            <div class="formula">Descuento = Bruto × 0.11</div>
            <div class="formula">Sueldo Neto = Bruto - Descuento</div>
        </div>
        
        <form action="${pageContext.request.contextPath}/Semanas/semana02/calcular05" method="POST">
            <div class="form-group">
                <label for="ventas"><i class="fas fa-chart-line"></i> Importe total vendido en el mes (S/)</label>
                <input type="number" id="ventas" name="ventas" step="0.01" min="0" required placeholder="Ingrese el importe de ventas">
            </div>
        ...
        <% if (request.getAttribute("sueldoBasico") != null) { %>
            <div class="resultados">
                ...
                <div class="result-card">
                    <div class="label">Comisión (9%)</div>
                ...
                <div class="result-card">
                    <div class="label">Descuento (11%)</div>
