...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1>Descuento del 11%</h1>
            <p class="descripcion">Una tienda ofrece un 11% de descuento sobre el importe de la compra. Además, obsequia 2 caramelos por cada unidad adquirida.</p>
        </div>
        
        <div class="formulas">
            <h3><i class="fas fa-calculator"></i> Fórmulas</h3>
            <div class="formula">Importe = Precio × Cantidad</div>
            <div class="formula">Descuento = Importe × 0.11</div>
            <div class="formula">A Pagar = Importe - Descuento</div>
            <div class="formula">Caramelos = Cantidad × 2</div>
        </div>
        
        <form action="${pageContext.request.contextPath}/Semanas/semana02/calcular01" method="POST">
            ...
            <div class="form-group">
                <label for="cantidad"><i class="fas fa-boxes"></i> Cantidad de unidades</label>
        ...
        <% if (request.getAttribute("importe") != null) { %>
            <div class="resultados">
                ...
                <div class="result-card">
                    <div class="label">Importe del descuento (11%)</div>
                ...
                <div class="result-card">
                    <div class="label">Caramelos obsequiados</div>
