...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 02 - Serie Fraccionaria | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-divide"></i> Serie Fraccionaria</h1>
            <p class="descripcion">Imprime y suma la serie: 2/5, 5/9, 8/13, 11/17, ... hasta n terminos.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Serie</h3>
            <div class="formula">2/5, 5/9, 8/13, 11/17, ...</div>
            <div class="formula">Numerador: +3 | Denominador: +4</div>
        </div>
        <form action="calcular02" method="POST">
            <div class="form-group">
                <label for="n"><i class="fas fa-hashtag"></i> Numero de terminos (n)</label>
                <input type="number" name="n" id="n" min="1" placeholder="Ejemplo: 5" required>
            </div>
