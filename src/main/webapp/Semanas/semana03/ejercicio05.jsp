...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 05 - Sueldo Vendedor | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-chart-line"></i> Sueldo Vendedor</h1>
            <p class="descripcion">Calculo del sueldo de un vendedor con sueldo basico mensual de S/300, comision del 9% sobre ventas y descuento del 11%.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Formulas</h3>
            <div class="formula">Sueldo Basico = S/ 300.00</div>
            <div class="formula">Comision = Importe Vendido x 0.09</div>
            <div class="formula">Sueldo Bruto = Sueldo Basico + Comision</div>
            <div class="formula">Descuento = Sueldo Bruto x 0.11</div>
            <div class="formula">Sueldo Neto = Sueldo Bruto - Descuento</div>
        </div>
        <form action="calcular05" method="POST">
            <div class="form-group">
                <label for="importeVendido"><i class="fas fa-hand-holding-usd"></i> Importe total vendido en el mes (S/)</label>
                <input type="number" name="importeVendido" id="importeVendido" step="any" min="0" placeholder="Ejemplo: 5000.00" required>
            </div>
        ...
        <div class="resultados">
            <div class="result-card">
                <div class="label"><i class="fas fa-wallet"></i> Sueldo Basico</div>
                <div class="valor">S/ <%= request.getAttribute("sueldoBasico") %></div>
            </div>
            <div class="result-card">
                <div class="label"><i class="fas fa-percentage"></i> Comision (9%)</div>
                <div class="valor">S/ <%= request.getAttribute("comision") %></div>
            </div>
            <div class="result-card">
            ...
            <div class="result-card">
                <div class="label"><i class="fas fa-minus-circle"></i> Descuento (11%)</div>
