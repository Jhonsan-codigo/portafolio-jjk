...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 06 - División Entera | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-divide"></i> División Entera</h1>
            <p class="descripcion">Hallar el cociente y el residuo (resto) de dos números enteros.</p>
        </div>
        <div class="formulas">
            <h3><i class="fas fa-function"></i> Fórmulas / Datos</h3>
            cociente = a / b | residuo = a % b
        </div>
        <form action="calcular06" method="POST">
            <div class="form-group"><label for="num1"><i class="fas fa-hashtag"></i> Dividendo (a)</label><input type="number" name="num1" id="num1" step="1" placeholder="Ejemplo: 17" required></div><div class="form-group"><label for="num2"><i class="fas fa-hashtag"></i> Divisor (b)</label><input type="number" name="num2" id="num2" step="1" placeholder="Ejemplo: 5" required></div>
        ...
        %>
        <% Integer cociente = (Integer) request.getAttribute("cociente"); Integer residuo = (Integer) request.getAttribute("residuo"); if (cociente != null && residuo != null) { %><div class="resultados"><div class="result-card"><div class="label"><i class="fas fa-divide"></i> Cociente</div><div class="valor"><%= cociente %></div></div><div class="result-card"><div class="label"><i class="fas fa-percentage"></i> Residuo</div><div class="valor"><%= residuo %></div></div></div><% } %>
