...
<head>
    <meta charset="UTF-8">
    <title>Ejercicio 04 - Cilindro | Jhon Contreras</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h1><i class="fas fa-database"></i> Cilindro</h1>
            <p class="descripcion">Diseñe un programa que determine el área total (A) y el volumen (V) de un cilindro del que se conoce su radio (r) y su altura (h).</p>
        </div>
        <div class="formulas">
        ...
        <form action="calcular04" method="POST">
            <div class="form-group"><label for="radio"><i class="fas fa-circle"></i> Radio (r) en metros</label><input type="number" name="radio" id="radio" step="any" min="0" placeholder="Ejemplo: 5" required></div><div class="form-group"><label for="altura"><i class="fas fa-arrows-alt-v"></i> Altura (h) en metros</label><input type="number" name="altura" id="altura" step="any" min="0" placeholder="Ejemplo: 10" required></div>
        ...
        %>
        <% String area04 = (String) request.getAttribute("area"); String volumen04 = (String) request.getAttribute("volumen"); if (area04 != null && volumen04 != null) { %><div class="resultados"><div class="result-card"><div class="label"><i class="fas fa-square"></i> Área Total</div><div class="valor"><%= area04 %></div><div class="unidad">m²</div></div><div class="result-card"><div class="label"><i class="fas fa-cube"></i> Volumen</div><div class="valor"><%= volumen04 %></div><div class="unidad">m³</div></div></div><% } %>
